...
namespace OLED12864_I2C {
     ...
     */
    //% blockId="OLED12864_I2C_NUMBER" block="在 x %x|y %y|顯示數字 %num|顏色 %color"
    //% weight=80 blockGap=8
    //% parts=OLED12864_I2C trackArgs=0
     ...
     */
    //% blockId="OLED12864_I2C_HLINE" block="在 x %x|y %y|畫上一條厚度 %len|顏色 %color 的水平線"
     ...
     * @param color is line color, eg: 1
     */
    //% blockId="OLED12864_I2C_VLINE" block="在 x %x|y %y|畫上一條厚度 %len|顏色 %color 的垂直線"
     ...
     * @param color is line color, eg: 1
     */
    //% blockId="OLED12864_I2C_RECT" block="從 x1 %x1|y1 %y1|畫到x2 %x2|y2 %y2|顏色 %color 的一個四邊形"
     ...
     */
    //% blockId="OLED12864_I2C_INVERT" block="轉換展示 %d"
     ...
     * draw / redraw screen
     */
    //% blockId="OLED12864_I2C_DRAW" block="繪畫"
     ...
     * turn on screen
     */
    //% blockId="OLED12864_I2C_ON" block="開啟"
     ...
     * turn off screen
     */
    //% blockId="OLED12864_I2C_OFF" block="關閉"
     ...
     */
    //% blockId="OLED12864_I2C_ZOOM" block="縮放 %d"
     ...
     */
    //% blockId="OLED12864_I2C_init" block="起始OLED，硬體位址為 %addr"
